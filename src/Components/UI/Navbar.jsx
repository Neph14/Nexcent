      ...
      <div className="border-2 w-full fixed top-0 right-0 left-0 z-50  ">
        <div className="lg:flex items-center justify-between w-full bg-white pt-2  pr-[10%] pl-[10%]">
          ...
          <div
            ...
            className="text-3xl absolute right-8 bottom-2 rounded-lg cursor-pointer lg:hidden  text-primary"
          >
            ...
            >
              {Links.map((link) => (
                ...
                >
                  <a
                    href={link.link}
                    className="text-neutral1 hover:text-gray-400 duration-500"
                  >
                    {link.name}
                  </a>
                </li>
              ...
              <div className="lg:pl-10 ">
                <button className="bg-primary px-5 py-1 rounded-lg text-white">
                  <h1 className="flex items-center text-white ">
                    <a
                      href=""
                      className=" text-xs lg:text-sm bg-[#4CAF4F] w-[133.25px] h-[36.49px] flex justify-center items-center font-inter "
                    >
                      Register Now
                    </a>
