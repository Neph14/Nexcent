...
function Calender() {
  return (
    <Fragment>
      <div className="bg-white w-full h-auto lg:h-[416.95px] flex justify-center items-center overflow-hidden py-5 lg:py-0">
        <div className="w-full lg:w-[90%] h-auto lg:h-full grid place-items-center lg:flex items-center justify-between lg:px-20">
          <div className="lg:w-auto lg:h-5/6">
            <img src={Pana} alt="Pana" className="w-full h-full" />
          </div>
